function [idx] = QRSDetect2(fileName)
    ...
    %subtract filters and sum both leads
    y1 = y21 - y11;
    y2 = y22 - y12;
    y = y1+y2;

    %final moving average / smoothing filter
    k = 5;
    gb = (1/k)*[1, zeros(1,k-1), -1];
    ga = [1, -1];
    y = filter(gb,ga,y);
    yH = y;
